...
// LOGGING
void
log_chunk_type (char *front, afi_riff_chunk_t *chunk)
{
  switch (chunk->type)
    {
    case 0:
...
void
log_chunks (char *front, afi_chunk_container_t *chunks)
{
...
void
log_wav_data (char *front, afi_wav_t *wav_data)
{
...
void
destroy_wav_data (afi_wav_t *wav_data)
{
