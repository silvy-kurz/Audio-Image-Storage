...
afi_result_t
get_chunk_count (FILE *file, u32 total_file_size, int *count_out)
{
...
afi_result_t
load_file_chunks (FILE *file, int chunk_count, afi_chunk_container_t **chunks_out)
{
...
afi_result_t
get_audio_format (u8 format, afi_audio_format_t *format_out)
{
  switch (format)
    {
    case 1:
...
afi_result_t
parse_chunks (afi_chunk_container_t *chunks, afi_wav_t *wav_data)
{
...
afi_result_t
read_wav (char *filename, afi_wav_t **data_out)
{
