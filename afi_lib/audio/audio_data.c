...
void log_frm_mo16_t(char *front, afi_frm_mo16_t frame) {
  printf("%s", front);
  log_i16("  Sample : ", frame.sample);
}

void log_frm_st16_t(char *front, afi_frm_st16_t frame) {
  printf("%s", front);
...
void log_frm_mo24_t(char *front, afi_frm_st16_t frame) {
  printf("%s", front);
  log_i16("  Left Sample : ", frame.left_sample);
  printf("%s", front);
  log_i16("  Right Sample : ", frame.right_sample);
...
void log_frm_st24_t(char *front, afi_frm_st16_t frame) {
  printf("%s", front);
